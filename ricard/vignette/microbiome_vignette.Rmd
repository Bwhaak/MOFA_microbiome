...
An overview of the data set is shown below:

<p align="center">
<img src="/Users/ricard/Google Drive/MOFA_microbiome/figures/Fig1_dataset_overview/figure1_vignette.png" style="width: 110%; height: 50%"/>
</p>
...
The data is already processed, filtered and normalised, you can see the details in [this script](XXX)
```{r}
# microbiome_data <- readRDS(url("ftp://ftp.ebi.ac.uk/pub/databases/mofa/snare_seq/seurat_rna.rds"))
...
The data consists of three views (no groups): quantification of bacterial, fungi and viral composition, respectively. Let's explore the data:
...
Helper function to plot weights. It will reduce the amount of code in the vignette:
```{r fig.wide = TRUE}
...
Please contact Bas (bashaak@live.nl) if you have questions regarding the data.
