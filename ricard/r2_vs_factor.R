...
r2.dt[view=="RNA expression",cum_r2:=cum_r2+0.25]
r2.dt[view=="Enhancer methylation",cum_r2:=cum_r2-0.25]
...
pdf(paste0(io$outdir,"/r2_vs_factor_v1.pdf"), width=6, height=4, useDingbats = F)
print(p)
dev.off()
